		...
		if (bitteja > puskurinKoko) {
			while (bitteja > puskurinKoko) {
				try {
					...
					if (DEBUG)
						System.out.println(" bittiPuskuri ennen lis‰yst‰: " + annaBittiStringi(bittiPuskuri, puskurinKoko));
					bittiPuskuri = bittiPuskuri << 8 | luettu;
					puskurinKoko += 8;
					if (DEBUG)
						System.out.println(" bittiPuskuri lis‰yksen j‰lkeen: " + annaBittiStringi(bittiPuskuri, puskurinKoko));
